...
if (!function_exists('addEventListener')) {
    function addEventListener(EventType $type, callable $listener, bool $useCapture = false): void {
        EventManager::getInstance()->addEventListener($type, $listener, $useCapture);
    }
}

if (!function_exists('removeEventListener')) {
    function removeEventListener(EventType $type, callable $listener, bool $useCapture = false): void {
        EventManager::getInstance()->removeEventListener($type, $listener, $useCapture);
    }
}

if (!function_exists('quitGame')) {
    /**
...
if (!function_exists('loadPreviousScene')) {
    /**
