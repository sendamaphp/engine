...
class Transform extends Component
{
    ...
    {
        if ($this->parent) {
            return Vector2::sum($this->parent->getPosition(), $this->position);
        }
    ...
    {
        if ($this->parent) {
            return Vector2::sum($this->parent->getScale(), $this->scale);
        }
        return $this->scale;
    }
    ...
    {
        if ($this->parent) {
            return Vector2::sum($this->parent->getRotation(), $this->rotation);
        }
     ...
     *
     * @param Transform|null $parent The parent of the transform.
     * @param bool $preserveWorldTransform
     * @return void
     */
